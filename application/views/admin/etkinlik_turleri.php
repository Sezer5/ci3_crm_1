                    ...
                    <div class="body table-responsive">
                        <table class="table table-hover table-bordered mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?=$rs->Id?></td>
                                    <form action="<?=base_url()?>admin/etkinlik_turleri/etkinlik_turleri_guncelle/<?=$rs->Id?>" method="post">
                                        <td><input type="text" name="tur_adi" class="form-control" value="<?=$rs->tur_adi?>"></td>
                                        <td><input type="text" name="birim" class="form-control" value="<?=$rs->birim?>"></td>
                                        <td><button type="submit" class="btn btn-success"><i class="icon-refresh"></i></button></td>
                                    </form>
                                    <td>
                                        <a href="<?=base_url()?>admin/etkinlik_turleri/etkinlik_turleri_sil/<?=$rs->Id?>">
                ...
                <div class="card">
                    ...
                    <div class="body table-responsive social_media_table">
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    <form action="<?=base_url()?>admin/etkinlik_turleri/etkinlik_turleri_ekle" method="post">
                                        <td><input type="text" name="tur_adi" class="form-control"></td>
                                        <td><input type="text" name="birim" class="form-control"></td>
